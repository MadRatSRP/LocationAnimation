package com.madrat.locationanimation;
...
public class MainActivity extends FragmentActivity {
    ...
    private GoogleMap.OnMapClickListener mMapClickListener = new GoogleMap.OnMapClickListener() {
        ...
        public void onMapClick(LatLng point) {
            if (mMarker != null) {
                mMapFragment.animateMarkerToGB(
                    mMarker,
                    point,
                    mLatLngInterpolator,
                    1500
    ...
    public static class SyncedMapFragment extends SupportMapFragment {
        ...
        public View onCreateView(
            ...
            mWrapper.addView(super.onCreateView(
                inflater,
                container,
                savedInstanceState
            ));
        ...
        public static class MapViewWrapper extends FrameLayout {
            ...
            public void animateMarkerToGB(
                ...
                mAnimations.add(new MarkerAnimation(
                    marker,
                    finalPosition,
                    latLngInterpolator,
                    duration
            ...
            private static class MarkerAnimation {
                ...
                public boolean animate() {
                    ...
                    mMarker.setPosition(mLatLngInterpolator.interpolate(
                        v,
                        mStartPosition,
                        mFinalPosition
                    ));
